...
public class PaymentDomainServiceImpl implements PaymentDomainService {
    ...
    @Override
    public PaymentEvent validateAndInitialitePayment(Payment payment, CreditEntry creditEntry, List<CreditHistory> creditHistories, List<String> failureMessages) {
